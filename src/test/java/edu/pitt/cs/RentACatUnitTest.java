...
public class RentACatUnitTest {
	...
	public void testGetCatNullNumCats0() throws Exception {
		RentACat rNoCats = RentACat.createInstance(InstanceType.IMPL);

		var method = rNoCats.getClass().getDeclaredMethod("getCat", int.class);
		method.setAccessible(true);

		Object result = method.invoke(rNoCats, 2);
		assertNull("Expected getCat(2) to return null", result);
	...
	public void testRentCatFailureNumCats3() {
		...
		boolean result = r.rentCat(2);
		assertFalse(result); // Expect the rent attempt to fail because c2 is already rented
