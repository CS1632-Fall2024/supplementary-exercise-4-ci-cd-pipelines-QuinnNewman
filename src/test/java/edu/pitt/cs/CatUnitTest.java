...
public class CatUnitTest {
	...
	public void testGetRented() {
		assertFalse("The cat should not be rented upon creation", c.getRented());
	}
	...
	public void testReturnCat() {
		...
		assertTrue("The cat should be rented after rentCat() is called", c.getRented());
		c.returnCat();
		assertFalse("The cat should not be rented after returnCat() is called", c.getRented());
	}
